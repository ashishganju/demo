                            ...
                            <div class="header_right d-flex">
                                    <div class="short_contact_list">
                                       ...
                                       Logout <i class="fa fa-sign-out" aria-hidden="true"></i>
                                        ...
                                        <!-- <button class="cod" type="submit"><a href="">Logout</a></button> -->
                            </div>
                                ...
                                <div class="main-menu  d-none d-lg-block">
                                    <nav class="abc">
                                        ...
                                        <li><a href="SLFindia-interior-code/index.html">Interior </a></li>
                                            ...
                                            <li><a class="active" href="properties.php">Book Online </a>
                                                <!-- <ul class="submenu">
                    ...
                    <div class="single_property">
                        ...
                        <div class="property_content">
                            <div class="main_pro">
                                    ...
                                    <button class="amount" type="submit"><a href="admin/dashboard.html">Book Now</a></button>
                            </div>
                        </div>
...
<!-- Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This Website is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">SLD</a> -->
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        <!-- </p>
                    </div>
                </div>

                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="query" id="query" cols="30" rows="9"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Write your query'" placeholder=" Write your query"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your name'"  placeholder="Enter your name">
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6 col-lg-4">
                                <div class="footer_widget">
                                        ...
                                        <!-- <p class="newsletter_text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Animi tempora eum vitae.</p> -->
                                    </div>
                        </div>
                    </div>
                </div>

                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-10 offset-xl-1">
                                <div class="slider_text text-center justify-content-center">
                                    <h3>Searches Filter</h3>
                                    <p>Esteem spirit temper too say adieus who direct esteem.</p>
                                </div>
                                <!-- <div class="property_form"> -->

                                    <!-- <form action="/SLF_INDIA/finder.php" method="POST">
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="form_wrap d-flex">
                                                        <div class="single-field max_width ">
                                                                ...
                                                                <select class="wide" name="location" id="location" >
                                                                        <option data-display="Select" name="location" id="location">Select</option>
                                                                        <option value="1" name="location" id="location">Lucknow</option>
                                                                        <option value="2" name="location" id="location">Chandigarh</option>
                                                                        <option value="3" name="location" id="location">Chandigarh</option>
                                                                </select>
                                                            </div>
                                                        <div class="single-field max_width " >
            ...
            <div class="row">
                ...
                <div class="col-xl-5">
                    <div class="call_add_action">
                        ...
                        <a href="#" class="boxed-btn3-line">Property Finder</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-6 col-lg-4">
                            <div class="footer_widget">
                                    ...
                                    <form id="contactForm"  action="/realestate2/home.php"  method="POST" class="newsletter_form">
...
<!-- Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This Website is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">SLF</a> -->
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        <!-- </p>
                    </div>
                </div>

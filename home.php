...
<body>
                        ...
                        <div class="col-xl-7 col-md-7">
                            <div class="header_right d-flex">
                                    <div class="short_contact_list">
                                            <ul>
                                                <li><a href="#"> <i class="fa fa-envelope animate__animated animate__bounce"></i> ashishshubham@gmail.com</a></li>
                            ...
                            <div  class="llo">
                                <div class="llo" class="logo" >
                                    <a href="welcome.php">
                                        ...
                                        <h1 class="hh  wow pulse ">SLF INDIA</h1>
                                    </a>
                                </div>
                            </div>
                            ...
                            <!-- class="main-menu  d-none d-lg-block" -->
                                <div class="main-menu d-none d-lg-block">
                                    <nav class="abc">
                                        ...
                                        <!-- class="active" -->
                                            <li><a  class="active animate__animated animate__bounce" href="welcome.php">Home</a></li>
                                        ...
                                        <!-- </li> -->
                                            <li class="animated bounce"><a href="SLFindia-interior-code/index.php">Interior </a>
                                            ...
                                            <!-- Property.html -->
                                            <li class="animate__animated animate__bounce"><a href="#">Projects <i class="ti-angle-down"></i></a>
                                            ...
                                            <!-- <i class="ti-angle-down"></i> -->
                                            <li class="animate__animated animate__bounce"><a href="properties.php">Book Online</a>
                                                <!-- <ul class="submenu">
                                            ...
                                            <li class="animate__animated animate__bounce"><a href="contact.php">Contact Us </a></li>
                             ...
                             <div  class="col-xs-3 col-lg-3 d-none d-lg-block ">
                                <div class="Appointment">
                                    ...
                                    <div  class="book_btn d-none d-lg-block animate__animated animate__bounce">
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-10 offset-xl-1">
                                <div class="slider_text text-center justify-content-center ">
                                    <h3 class="wow zoomIn" data-wow-duration="2.5s" >Find your best Property</h3>
    ...
    <div class="popular_property">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-6 col-md-8 col-lg-6  wow zoomInLeft">
                ...
                <div class="col-xl-6 col-md-8 col-lg-6  wow zoomInRight">
                    <div class="single_property">
                        <div class="property_thumb">
                ...
                <div class="col-xl-6 col-md-8 col-lg-6  wow zoomInLeft" data-wow-delay="0.1s">
                    <div class="single_property">
                        <div class="property_thumb">
                            <div class="property_tag">
                                    For Sale
                ...
                <div class="col-xl-6 col-md-8 col-lg-6  wow zoomInRight" data-wow-delay="0.1s">
                    <div class="single_property">
                        <div class="property_thumb">
                            <div class="property_tag red">
                                    For Rent
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-6 col-lg-4">
                            <div class="footer_widget">
                                    ...
                                    <form id="contactForm"  action="/SLF_INDIA/welcome.php"  method="POST"  class="newsletter_form">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <p class="copy_right text-center">
                            ...
                            <!-- _blank -->
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This Website is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="">SLF</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>

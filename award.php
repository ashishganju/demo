                            ...
                            <div class="col-xl-6 col-lg-7">
                                <div class="main-menu  d-none d-lg-block">
                                    <nav class="abc">
                                        ...
                                        <!-- </li> -->
                                        <li><a href="SLFindia-interior-code/index.html">Interior </a>
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-10 offset-xl-1">
                                <div class="slider_text text-center justify-content-center">
                                    <h3> It's doesn't matter<br>
                                         how many times you win an award<br>
                                         it feels new everytime<br>
                                               ...
                                               <div>
                                                    <h4 class="mb-15">
                                                            <p class = "text-justify">
                                                                ...
                                                                Between effort and success, when one looks back at these moments, 
                                                                one gets the push to do better. Omaxe expresses its heartfelt 
                                                                gratitude for these tokens of appreciation that have spurred 
                                                                us on in our quest to give people their dream spaces. </p>                                                              </p>
                                                        </h4>
                                                        
                                                        <div class="row">
                                                            <div  class="col-sm-2">
                                                                <img src="img/svg_icon/collaboration.svg" alt="collaboration" class="img-thumbnail ">
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <img src="img/svg_icon/calendar.svg" alt="on-time" class="img-thumbnail">
                                                    </div>
                                                      
                                                    <div class="col-sm-2">
                                                        <img src="img/svg_icon/idea.svg" alt="idea" class="img-thumbnail">
                                                </div>
                                                
                                                <div class="col-sm-2">
                                                    <img src="img/svg_icon/goal.svg" alt="goal" class="img-thumbnail">
                                            </div>

                                      ...
                                      MISSION </h2>
                                                    ...
                                                    <h4 class="mb-15 ">
                                                            <p class = "text-justify">
                                                                    ...
                                                                    Goodwill is a social enterprise
                                                                    providing individuals
                                                                    and opportunities to enhance their lives
                                                                    through meaningfull employement
                                                                    Every day push our boundaries intending 
                                                                    to build happy spaces for people. Customer
                                                                    satisfaction is our priority and creating 
                                                                    value for stakeholders is what we strive 
                                                                    to do. Through professionalism, transparency
                                                                    and quality, we’ve come a long way in the real estate
                                                                    industry and there is still far to go.
                                                        ...
                                                        <div class="row">
                                                        <div  class="col-sm-2">
                                                            <img src="img/mission&vission/satisfactionmeter.png" alt="opportunity" class="img-thumbnail ">
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <img src="img/mission&vission/guarantee.png" alt="opportunity" class="img-thumbnail">
                                                </div>
                                                <div class="col-sm-2">
                                                    <img src="img/mission&vission/strongpartnership.jpg" alt="strongpartnership" class="img-thumbnail">
                                            </div>
                                                        </div>
                                                        </div>>
                ...
                <
                                                <div class="col-xl-12 col-lg-12">
                                                     <div>
                                                        ...
                                                        <h4 class="mb-15">
                                                            <p class = "text-justify">
                                                                To understand our social responsibility and
                                                                be a trusted leader in the real estate sector 
                                                                contributing towards a progressive India.
                                                        ...
                                                        <div class="row"">
                                                            <div class="col-sm-2">
                                                                <img src="img/mission&vission/oppotunity.jpg" alt="opportunity" class="img-thumbnail">
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <img src="img/mission&vission/guarantee.png" alt="opportunity" class="img-thumbnail">
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <img src="img/svg_icon/team.svg"" alt="equality" class="img-thumbnail">
                                                </div>
                                                            </div>
                                                    </div>

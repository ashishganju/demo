                                            ...
                                            <div class="col-xl-12">
                                                <div class="form_wrap d-flex">
                                                        <div class="single-field max_width ">
                                                                ...
                                                                <!-- <select type="text" class="wide" name="location" >
                                                                    
                                                                    <option data-display="Select" name="location" id="location">Select</option>
                                                                    <option value="1" name="location" >Lucknow</option>
                                                                    <option value="2" name="location" >Chandigarh</option>
                                                                    <option value="3" name="location">Chandigarh</option> -->
                                                                </select>
                                                            </div>
                                                            <div class="single-field max_width " >
                                                            ...
                                                            <div class="serach_icon">
                                                                    <a href="finder.php">
                                                                            <!-- <i class="ti-search"></i> -->
                                                                            <button type="submit" name="search" class="ti-search" ></button>
                                                                    </a>
                                                                </div>
                                                </div>
                                            </div>

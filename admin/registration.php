                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        <?php
                                        $i=1;
include'include/signupconfig.php';
...
?>
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                            <!-- </td> -->
                                            <!-- <td><img src="images/property_image/ -->
                                            <?php
                                            //  echo $img;
                                             ?>
                                             <!-- " width="120"></td> -->
                                             <td>
    <!-- <a class='btn btn-info'   href="update_property.php?&id= -->
    <?php
    //  echo $id;
     ?>
     <!-- "> -->
     <!-- <span class="glyphicon glyphicon-pencil"></span></a> -->
    <!-- <a class='btn btn-danger' onclick="delet( -->
        <?php
        //  echo $id;
        ?>
        
        
        <!-- <span class="glyphicon glyphicon-remove" style="color:white;"></span></a> -->

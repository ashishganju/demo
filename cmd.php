...
<body>
    ...
    <header>
      ...
      <!-- <li  class="code" > -->
      <!-- class="nav-link" -->
        <!-- <button class="cod" type="submit"><a href="logout.php">Logout</a></button> -->
      <!-- </li> -->
      <!-- class="nav-item" -->
      <!-- <li  class="code"> -->
      <!-- class="nav-link" -->
      <!-- <button class="cod" type="submit"><a  href="signup.php">Signup</a></button> -->
      <!-- </li> -->
      <!-- class="nav-item" -->
      <!-- <li  class="code"> -->
      <!-- class="nav-link" -->
                    ...
                    <div class="header_bottom_border">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-7">
                                <div class="main-menu  d-none d-lg-block">
                                    <nav class="abc">
                                        <ul id="navigation" class="hov" >
                                            ...
                                            <!-- <li><a  href="index.html">Enquire Now <i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
                                                <li><a href="call.html">Call Now</a></li>
                                                        <li><a href="property.html">Our Exclusive Property</a></li>
                                                        <li><a href="testimonials.html">Testimonials</a></li>
                                                        <li><a href="book.html">Book Online</a></li>
                                            </ul> -->
                                        <!-- </li> -->
                                        <li><a href="SLFindia-interior-code/index.html">Interior </a></li>
                                            ...
                                            <li><a href="properties.php">Book Online</a>
                                                <!-- <ul class="submenu">
                                                        <li><a href="annual.html">Annual Reports and Others</a></li>
                                                        <li><a href="financials.html">Financials</a></li>
                                                        <li><a href="investorcon.html">Investor Contact</a></li>
                                                        
                                                </ul> -->
                                            </li>
                                            <!-- <li><a href="#">Careers <i class="ti-angle-down"></i></a>
                                                <ul class="submenu">
                                                        <li><a href="currentopen.html">Current Opening</a></li>
                                                        <li><a href="enployeewall.html">Employee Wall</a></li>
                                                    
                                                        
                                                </ul>
                                            </li> -->

                                            <!-- <li><a href="#">Company Care <i class="ti-angle-down"></i></a>
                                                <ul class="submenu">
                                                        <li><a href="currentopen.html">Current Opening</a></li>
                                                        <li><a href="enployeewall.html">Employee Wall</a></li>
                             ...
                             <!-- class="col-xs-3 col-lg-3 d-none d-lg-block " -->
                             <div  class="col-xs-3 col-lg-3 d-none d-lg-block ">
                                <div class="Appointment">
                                    <div class="search_btn" class="tto" >
                                        <a href="#" >
                                    ...
                                    <div  class="book_btn d-none d-lg-block">
                                        <a href="finder.php">Property Finder</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="myNav" class="overlay">
                                ...
                                <div class="overlay-content">
                                    ...
                                    <a href="#">Investors</a>
                                    <a href="#">Careers</a>
                                    <a href="#">Company Care</a>
                                </div>
                              </div>
                              
                                <span class="ss"style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776;</span>
            ...
            <div class="container">
                <
                        <div class="col-xl-12 col-lg-12">
                                <div>
                                    <h3>
                                        PARTNERSHIPS ARE ALL ABOUT SEEING THE OTHER PERSON'S VIEWPOINT.</h3>
                                      <h4>MR.SHIVEN</h4>
                                      </div>
                                               ...
                                               <div>
                                                    <h4 class="mb-15">
                                                            <p class = "text-justify">
                                                                ...
                                                                In the last three decades, you have reposed unflinching faith in us and that has made this journey eventful. From a modest beginning in 1987 to becoming one of India’s leading real estate development companies, Omaxe has come a long way in a very short span of time. Today, Omaxe stands tall on the foundation of its values and is passionately guided by its mission of delivering new-age homes to fellow Indians. Spreading into uncharted geographies, delivering millions of sq. ft. across all price points and continuing to remain focused on the housing needs of the common man not only in Tier-I cities but also in destinations that are new to organized real estate. We have successfully blended our business growth with social endeavours by bringing a change in the lives of people who are deprived of health, education and social justice.

                                                                In reciprocation, the market recognizes us as a responsible leader. The awards and accolades bestowed upon us in the last three decades have only made us more accountable. We acknowledge the huge responsibility that rests upon us to make a difference not only in the lives of people who are associated with us but every Indian who aspires for a home. We strive very hard to be transparent, offer quality products and assure complete customer satisfaction.
                                                                
                                                                We believe that value creation is an everlasting phenomenon and trust is not built overnight.
                                                                </p>
                                                        </h4>
                ...
                <div class="row">
                    ...
                    <!-- <div class="col-xl-4 col-md-6 col-lg-4">
                            <div class="footer_widget">
                                    ...
                                    <!-- <form id="contactForm"  action="/realestate2/index.php"  method="POST"  class="newsletter_form">
                                    <!-- onblur="validateEmail(this);" -->
                                        <!-- <input type="email" name="email" id="email"    placeholder="Enter your mail">
                                <span id="message"> </span>
                                        <button type="submit">Subscribe</button> -->
                                    <!-- </form>
                                    <p class="newsletter_text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Porro veritatis dolorum placeat qui quod!</p>
                                </div>  -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <p class="copy_right text-center">
                            ...
                            <!-- _blank -->
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This Website is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://www.fb.com" target="">SLF</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
